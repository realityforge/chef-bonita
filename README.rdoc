...
cookbook has been tested with the "Subscription Pack" 5.6 version of the Bonita product. First you need to download the
...
"com.bonitasoft:bonitasoft-server-sp:5.6:tomcat:zip".
